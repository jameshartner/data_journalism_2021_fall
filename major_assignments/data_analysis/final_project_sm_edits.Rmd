...
select(senator_full_name, position_held, entity)
...
filtered_data <- bind_rows(senate_assets, senate_positions,senate_earned_income, senate_positions, senate_agreements)
#####
...
ppp_sba_loan_urls <- ppp_sba_loan_urls %>%
  head(1)
...
for (ppp_sba_loan_url in ppp_sba_loan_urls) {
  ...
  ## 
  ppp_loan_slice <- read_csv(ppp_sba_loan_url, col_types=ppp_cols, n_max=100000) 
