...
plot(pressure)testing<-all_match_results %>%
filter(str_detect(BorrowerName, "^BIRD DOG HOSPITAL"))

final_dataset_test<-read_rds("ppp_slices/file_us_900000.rds") %>%
  filter(str_detect(BorrowerName, "^BIRD DOG"))
```
#date<-today()
