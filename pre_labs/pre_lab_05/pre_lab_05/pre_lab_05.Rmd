...
**Answer**
There are 195,865 records in this table.
...
**Answer**
There are quite a few problems, but the one that sticks out to me is the capitalization of some city names. For example, with Aberdeen, there is one set title "aberdeen" and another with "Aberdeen."
...
**Answer**
Two changes that were made were "PHOENIX" was cleaned to "Phoenix" and "WESTMINSTER" was cleaned to "Westminster."
```{r}
...
**Answer**
In this, the refinr function changed "aberdeen" to "Aberdeen," "ABERDEEN PROVING GROUND" to "Aberdeen Proving Ground" and "ABELL" to "Abell." This is going to help group the right names together. 
...
**Answer**
No, the changes seem to be the same actually.
```{r}
cleaned_md_loans <- md_loans %>%
